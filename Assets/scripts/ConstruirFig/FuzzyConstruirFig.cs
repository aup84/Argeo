...
public class FuzzyConstruirFig {
    ...
    void InitFuzzyEngine()
    {
        ...
        */
        ...
        FuzzySet fsFast = new FuzzySet("Fast", new TrapezoidalFunction(0.0, 0.40, TrapezoidalFunction.EdgeType.Right));
        FuzzySet fsNormal = new FuzzySet("Normal", new TrapezoidalFunction(0, 0.40, 0.65, 1.00));
        FuzzySet fsSlow = new FuzzySet("Slow", new TrapezoidalFunction(0.65, 1.00, TrapezoidalFunction.EdgeType.Left));
